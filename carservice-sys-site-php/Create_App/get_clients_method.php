        ...
        if (isset($_POST["update_client"])){
            ...
            if (strtolower($_POST['lastname_to_search'] ?? "") == "all") {
                ...
                if (isset($_POST['submit_form'])) {
                    ...
                    echo("<script>
                    alert('Enter field can not be empty! ❌');
                    window.location.href = 'get_clients_method.php';
                </script>");
                }
            }
        ...
        <div id="show_clients_page">
            ...
            <div id="cont_for_scrollTable">
                ...
                <table>
                    ...
                    <td> <form method="get" action='Create_App.php'> <input type='submit' id='update_client' name='update_client' value='set'> </td> <td><input style='display: none;' type='text' id='id' name='id' value='<?php echo $row['ClientID'] ?>'></td> </form>
